...
Jól struktúrált látens terek esetében értelme van a látens pontokat vektorként kezelni, melyek összegezhetőek és kivonhatóak egymásból. Az \ref{interp} ábrán négy kép látható. Mindegyik kép bal felső sarkában $3$ bázis kép van kirajzolva, melyek a tényleges adathalmazból származnak. A kép maradék része egy négyzetrács, melynek bal felső, jobb felső és bal alsó sarkaiban ezen három adatképnek a rekonstrukciója látható.
...
\begin{center}
  ...
  \caption{Bal felső: $\beta=0.2$, jobb felső: $\beta=2$, Bal alsó: $\beta=2$, jobb alsó: $\beta=6$,}
\end{center}
\end{figure}
